...
public class FindTheSumsTester {
	...
	private static void horizontalSumsTest(){
		...
		arrayAsString = FindTheSums.arrayToString(array3);
		System.out.println(arrayAsString);
		System.out.println("horizontalSums(array1, 7):");
		horizontalSums = FindTheSums.horizontalSums(array3, 3);
		arrayAsString = FindTheSums.arrayToString(horizontalSums);
		System.out.println(arrayAsString);
		System.out.println("array2:");
		horizontalSums = FindTheSums.horizontalSums(array3, 10);
		arrayAsString = FindTheSums.arrayToString(horizontalSums);
		System.out.println(arrayAsString);
		System.out.println("array2:");
		arrayAsString = FindTheSums.arrayToString(array4);
		System.out.println(arrayAsString);
		System.out.println("horizontalSums(array2, 20):");
		horizontalSums = FindTheSums.horizontalSums(array4, 3);
		arrayAsString = FindTheSums.arrayToString(horizontalSums);
		System.out.println(arrayAsString);
		System.out.println("horizontalSums(array2, 25):");
		horizontalSums = FindTheSums.horizontalSums(array4, 4);
		arrayAsString = FindTheSums.arrayToString(horizontalSums);
		System.out.println(arrayAsString);
		System.out.println();
	}
	...
	private static void verticalSumsTest(){
		...
		verticalSums = FindTheSums.verticalSums(array3, 5);
		...
		verticalSums = FindTheSums.verticalSums(array4, 3);
		arrayAsString = FindTheSums.arrayToString(verticalSums);
		System.out.println(arrayAsString);
		System.out.println("verticalSums(array2, 33):");
		verticalSums = FindTheSums.verticalSums(array4, 4);
		arrayAsString = FindTheSums.arrayToString(verticalSums);
		System.out.println(arrayAsString);
		System.out.println();
	}
